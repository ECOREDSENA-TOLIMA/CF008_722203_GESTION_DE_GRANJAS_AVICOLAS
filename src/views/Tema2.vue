  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    SlyderF.mb-5(columnas="col-lg-6 col-xl-4")
      .tarjeta.color-acento-botones7.p-4
        ...
        p.text-center Debe haber una al entrar a las granjas para que el personal que va a ingresar se dé una ducha, se vista con la indumentaria adecuada. 
        
      .tarjeta.color-acento-botones8.p-4
        .row.justify-content-center.mb-3
          .col-8
            img(src='@/assets/curso/temas/tema2/img-8.svg' alt='AvatarTop')
        p.text-center Los servicios sanitarios deben estar ubicados correctamente, de fácil acceso y en la proporción adecuada con el personal. La proporción es de 1 por cada 15 empleados.

      .tarjeta.color-acento-botones9.p-4
        .row.justify-content-center.mb-3
          .col-8
            img(src='@/assets/curso/temas/tema2/img-9.svg' alt='AvatarTop')
        p.text-center Los baños deben tener las condiciones sanitarias requeridas, divididos por género y totalmente funcionales, es decir, con lavamanos, duchas, vestieres, e inodoros. Deben estar siempre aseados y lejos de las áreas de producción y almacén.

      .tarjeta.color-acento-botones10.p-4
        .row.justify-content-center.mb-3
          .col-8
    ...
    .tarjeta.tarjeta.color-acento-contenido2.p-4.mb-5
      SlyderA(tipo="b")
        .row
          .col-md-6.mb-4.mb-md-0
            p Los empleados de la avícola deben portar el uniforme adecuado de color claro, limpio, y calzado cerrado de material resistente e impermeable, guantes y gorro de ser necesario. Lo anterior, debe estar diseñado para que no se guarden elementos contaminantes. 
        ...
        .row
          .col-md-6.mb-4.mb-md-0
            p Las manos y uñas deben estar limpias, las uñas cortas sin esmaltes y sin ningún tipo de accesorio.
        ...
        .row
          .col-md-6.mb-4.mb-md-0
            p El personal no debe presentar afecciones como: hongos, forúnculos, dermatitis, diarrea, vómito, fiebre, gripe, entre otros, que puedan interferir sanitariamente con los procesos, no deben comer, beber o fumar en áreas de proceso y deben evitar trasladarse innecesariamente de su puesto de trabajo hacia otras zonas. 
        ...
        .row
          .col-md-6.mb-4.mb-md-0
            p Los visitantes deben cumplir también con la indumentaria pertinente para la producción. 
        ...
        .row
          .col-md-6.mb-4.mb-md-0
            p Se debe capacitar adecuadamente al personal vinculado con el proceso en su labor específica, ejemplo, en programas de limpieza y desinfección, manejo y aplicación de biológicos, prevención de riesgos, detección de problemas, manejo y acciones o medidas correctivas frente a los mismos, pero además se deben capacitar en temas que hagan mejorar su entorno y su crecimiento personal.
    ...
    p.mb-5 Los equipos deben estar ubicados siguiendo una secuencia lógica del proceso tecnológico y que eviten la contaminación cruzada, además deben contar con los instrumentos y accesorios para medición y registro de variables del proceso (termómetros, higrómetros, termógrafos, pH-metros, etc.).
    ...
    .bloque-texto-g.color-primario.p-3.p-sm-4.p-md-5.mb-5
      ...
      .bloque-texto-g__texto.p-4(data-aos="fade-left")
        p.mb-0 Para conocer más acerca de las BPB (Buenas Prácticas Bioseguras) se recomienda consultar:<br><br>
        ul.lista-ul
          li 
            i.lista-ul__vineta
            | Las Buenas Prácticas de Bioseguridad en Granjas de Reproducción Aviar.<br>
          li 
            i.lista-ul__vineta
            | Plantas de Incubación, Conceptos Básicos para su Aplicación en Colombia.<br>
          li  
            i.lista-ul__vineta
    ...
    p.mb-5 En las instituciones procesadoras de alimentos el personal interviene en varios procesos en donde manipula utensilios y equipos, debido a lo cual, se hace necesaria la implementación de los planes de procedimiento y saneamiento que reduzcan los riesgos de productos contaminados, además estos, deben estar bien documentados. Dichos riesgos pueden ser de tres tipos:
    ...
    .tarjeta.tarjeta.color-acento-botones10.p-4.mb-5
      SlyderA(tipo="b")
        .row
          .col-md-6.mb-4.mb-md-0
            h4 Instalaciones y equipos
            p En general deben estar diseñadas en materiales resistentes, impermeables, no porosos, no absorbentes y de fácil acceso para su limpieza y estar distribuidos de una forma secuencial y lógica. Debe haber servicios sanitarios suficientes y suministro de recursos como el agua, entre otros.
        ...
        .row
          .col-md-6.mb-4.mb-md-0
            h4 Requisitos higiénicos de fabricación
            p Los proveedores, materias primas, empaques e insumos, deben cumplir con criterios claros de calidad, y de igual manera durante el proceso se es necesario aplicar métodos y controles que garanticen la inocuidad del producto y prevengan su contaminación.
        ...
        .row
          .col-md-6.mb-4.mb-md-0
            h4 Personal manipulador de alimentos
            p Debe cumplir estrictas normas de higiene y protección: demostrar un buen estado de salud y acogerse a un plan de capacitación continuo y permanente de mínimo 10 horas anuales.
        ...
        .row
          .col-md-6.mb-4.mb-md-0
            h4 Asegurar la calidad e inocuidad del producto
            p Se requieren implementar sistemas de control de calidad con enfoque preventivo y que abarque todas las etapas del proceso, aplicar Planes de Muestreo y herramientas como HACCP.
        ...
        .row
          .col-md-6.mb-4.mb-md-0
            h4 Saneamiento
            p Se debe implementar un plan de saneamiento que contenga como mínimo un programa de limpieza y desinfección, un programa de manejo integral de residuos, un programa de prevención de plagas y un programa de abastecimiento de agua potable con sus respectivos protocolos y listas de chequeo.
        ...
        .row
          .col-md-6.mb-4.mb-md-0
            h4 Almacenamiento, distribución, transporte y comercialización del producto
            p Aplicar adecuados sistemas de rotación y conservación del producto con base a sus características en bodegas o equipos totalmente limpios y con distancias correctas entre piso producto y piso - pared.
    ...
    ul.lista-ul
      li 
        i.lista-ul__vineta
        | Mantener las uñas cortas y limpias de cualquier suciedad.
      li 
        i.lista-ul__vineta
        | Lavarse las manos antes de iniciar el turno de trabajo y cada vez que el proceso lo requiera..
      li  
        i.lista-ul__vineta
        | No maquillarse las uñas o portar joyas y/o accesorios. 
      li  
        i.lista-ul__vineta
        | Proteger cuidadosamente los cortes o heridas de las manos con apósitos, cubrir los cortes o heridas con vendajes, curitas u otros elementos impermeables, con el fin de que los alimentos no tengan contacto. 
    p.mb-5 Para lavarse las manos adecuadamente, según Malekian Fatemeh et al. (2011), es necesario seguir estos pasos cuyo procedimiento completo se realiza entre 20 y 25 segundos.

    SlyderF.mb-5(columnas="col-lg-6 col-xl-4")
      .tarjeta.color-acento-botones7.p-4
        .row.justify-content-center.mb-3
          .col-8
            img(src='@/assets/curso/temas/tema2/decorador-1.svg' alt='AvatarTop')
        p.text-center Humedecer  brazos y manos  con agua corriente,  a una temperatura de más o menos 38°C o en su defecto  la que se pueda tolerar.

      .tarjeta.color-acento-botones8.p-4
        .row.justify-content-center.mb-3
          .col-8
            img(src='@/assets/curso/temas/tema2/decorador-2.svg' alt='AvatarTop')
        p.text-center Aplicar jabón suficiente y restregar hasta formar una buena cantidad de espuma. 

      .tarjeta.color-acento-botones9.p-4
        .row.justify-content-center.mb-3
          .col-8
            img(src='@/assets/curso/temas/tema2/decorador-3.svg' alt='AvatarTop')
        p.text-center Frotar brazos y manos de acuerdo a lo sugerido en las técnicas de lavado de manos, limpiando entre los dedos y debajo de las uñas, este procedimiento debe durar entre 10 y 15 minutos.

      .tarjeta.color-acento-botones10.p-4
        .row.justify-content-center.mb-3
          .col-8
            img(src='@/assets/curso/temas/tema2/decorador-4.svg' alt='AvatarTop')
        p.text-center Enjuagar brazos y manos con abundante agua asegurándose de retirar todo el jabón y la suciedad.

      .tarjeta.color-acento-botones10.p-4
        .row.justify-content-center.mb-3
          .col-8
            img(src='@/assets/curso/temas/tema2/decorador-5.svg' alt='AvatarTop')
        p.text-center Con una toalla de papel secar los brazos y manos o un secador de aire caliente. Para evitar la contaminación cruzada se recomienda el uso de una toalla desechable para cerrar la llave del agua.
    ...
    AcordionA.mb-5.bgr_7(tipo="b" clase-tarjeta="tarjeta tarjeta--azul")
      .row(titulo="Ducha personal").p-0
        .col-md-12.mb-4.mb-md-0
          p Ducharse antes de ir a trabajar es de gran importancia, ya que la ducha diaria, con abundante agua y jabón, debe formar parte de la rutina del manipulador, de no ser así deberá ducharse antes de empezar labores en la empresa.
      .row(titulo="Ropa de uso diario").p-0
        .col-md-12.mb-4.mb-md-0
          p Puede ser una fuente de contaminación para los productos alimenticios, ya que puede portar polvo, patógenos, humo, entre otros. 
          .row
            .col-md.mb-5.mb-sm-0
              p Se recomienda:
              ol.lista-ol
                ...
                li 
                  span.text-bold 5. 
                  | Guantes y calzado exclusivo.
      .row(titulo="Ropa de trabajo").p-0
        .col-md-12.mb-4.mb-md-0
          p Esta vestimenta de trabajo debe cumplir con los siguientes requerimientos:
          ul.lista-ul.mb-3
            li 
              i.lista-ul__vineta
            ...
            li  
              i.lista-ul__vineta
              | De tejidos que absorben fácilmente el sudor y que sea lavable o desechable.
            li  
              i.lista-ul__vineta
            ...
            li  
              i.lista-ul__vineta
              | Si se requiere del uso de guantes, estos deben: estar limpios, preferiblemente de un solo uso y en buen estado.
            li  
              i.lista-ul__vineta
      ...
      .row(titulo="Ingesta de alimentos").p-0
        .col-md-12.mb-4.mb-md-0
          p No ingerir alimento, mascar chicle o utilizar perfumes y maquillaje en la planta. Se debe asignar un espacio para el almacenamiento de alimentos y bebidas, externos al proceso que se lleva a cabo en la planta. Se permite beber agua en dispensadores o en vasos desechables con tapa y pitillo.
      .row(titulo="Fumar en el sitio de trabajo").p-0
        .col-md-12.mb-4.mb-md-0
    ...
    .col-xl-10.mx-auto.mb-5
      img.d-md-block(src="@/assets/curso/temas/tema2/cuadros.svg" data-aos="fade-down")

    p.mb-5 Algunos aspectos básicos que se deben tener en cuenta para el proceso de higienización son: la acción mecánica, los agentes químicos, el tiempo, temperatura de exposición y aplicación. Se deben retirar todos los residuos que se encuentren adheridos al equipo, eliminar manualmente las partículas gruesas que se encuentren en la superficie. El uso de agentes químicos (productos de limpieza disponibles en el mercado) u orgánicos. Además, se debe tener en cuenta el tiempo de exposición del producto y la temperatura de aplicación de este (Soluciones Gastronómicas, s.f.). Entre los más usados se encuentran los detergentes y desinfectantes:
    ...
    .tarjeta--container.row.mb-5
      .col-md.tarjeta.color-acento-contenido.p-5
        ...
        ul.lista-ul.mb-3
          li(style="color: #000") 
            ...
            | Álcalis inorgánicos:  utilizados comúnmente para limpiar grasas y proteínas, suelen aclararse mal y son muy corrosivos. Los más populares son el hidróxido potásico, carbonato sódico y   la soda cáustica.
          li(style="color: #000") 
            i.lista-ul__vineta(style="color: #000")
            | Ácidos: usados para eliminar depósitos de sales minerales, como los ácidos sulfúricos, nítrico, o clorhídrico.
          li(style="color: #000")  
            i.lista-ul__vineta(style="color: #000")
            | Secuestrantes: reaccionan con el calcio y magnesio del agua, de tal forma que ablandan el agua.
          li(style="color: #000")  
            i.lista-ul__vineta(style="color: #000")
      ...
      .col-md.tarjeta.color-primario.p-5
        ...
        ul.lista-ul.mb-3
          li 
            i.lista-ul__vineta
            | Compuestos clorados: ampliamente utilizados en el sector alimentario para la cloración del agua (para hacerla potable) y son corrosivos e irritantes. El más conocido es la lejía.
          li 
            i.lista-ul__vineta
