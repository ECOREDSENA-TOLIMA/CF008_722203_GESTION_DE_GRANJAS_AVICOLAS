  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 5
      h1 Definición de huevo, formación estructura y composición
    ...
    .row.mb-5
      .col-lg-12
        .cajon.color-primario.p-4.mb-4
          .h5 Cáscara
          p En gran parte, se encuentra formada por carbonato cálcico y tiene miles de poros que permiten que se produzca el intercambio gaseoso. Su función es proteger y aislar el contenido del huevo; además de mantener al embrión del que surgiría el pollito después de la eclosión. Adherido a la cáscara, se encuentran las membranas testáceas, las cuales tienen como propósito formar la cámara de aire en el polo más ancho del huevo.

      .col-lg-12
        .cajon.color-primario.p-4.mb-4
          .h5 Clara o albumen
          p Está formada por el albumen fluido y el albumen denso; su composición está compuesta especialmente por proteínas y agua. La frescura del huevo se puede delimitar por la textura y firmeza de la clara. 
