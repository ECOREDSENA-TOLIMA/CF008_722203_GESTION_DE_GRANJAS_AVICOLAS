  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    AcordionA.mb-5.bgr_7(tipo="b" clase-tarjeta="tarjeta tarjeta--azul")
      ...
      .row(titulo="Norma NTC-1240").p-0
        .col-md-12.mb-4.mb-md-0
          p Esta norma tiene como objeto el establecimiento de la clasificación del huevo de gallina, la cual se determina según su peso y establece los requisitos de calidad que debe cumplir el huevo fresco para consumo humano:
          ul.lista-ul
            li 
              i.lista-ul__vineta
              | Que tenga su cascara entera, sin grietas.
            li 
              i.lista-ul__vineta
              | Su superficie solo contenga menos del 25% de polvo, sin excremento de aves, sangre, o restos de huevo.  
            li  
              i.lista-ul__vineta
              | Que no haya sido sometido a algún procedimiento de lavado, tratamiento de conservación, fertilización o incubación.
          p De igual manera, esta norma NTC, determina que el almacenamiento del huevo de gallina fresco debe hacerse en un área limpia, ordenada, separada de sustancias químicas, plaguicidas o desinfectantes y por ende, debe ser desinfectada y un buen control de plagas. Además, este almacenamiento deberá hacerse sobre estibas o estantes limpios y retirado de las paredes y del piso.    
      .row(titulo="Resolución ICA 2909 DE 2010").p-0
        .col-md-12.mb-4.mb-md-0
          p <strong>Por medio de la cual se crean los Comités Sanitarios Avícolas Departamentales</strong>
          p A partir de esta resolución se conforman los comités interdisciplinarios para coadyuvar en la aplicación de la normatividad, la vigilancia y control en los temas relacionados con la producción aviar y la participación continua y acción frente al riesgo de posibles ataques de enfermedades que puedan afectar gravemente la avicultura, además estructura en su extensión la parte organizacional y funcional del dicho comité.
      .row(titulo="Norma NTC 2003-07-04").p-0
        .col-md-12.mb-4.mb-md-0
          p En esta norma se establecen los requisitos e instrucciones generales que se deben aplicar para cumplir con las Buenas Prácticas de Manufactura -BPM- en las etapas de recepción, clasificación, empaque y almacenamiento de huevos de gallinas destinados a su comercialización para consumo humano. 
          p Las instrucciones se deben emplear en los establecimientos o lugares donde se realizan los procesos tecnológicos de recepción, clasificación, empaque y almacenamiento de huevo comercial. De igual manera, al personal manipulador que interviene en los procesos, los equipos y utensilios utilizados en el desarrollo de las actividades y el huevo como alimento o materia prima.
          p Así mismo, esta norma establece que se debe contar con un sistema de rastreo que permita garantizar la atención oportuna de quejas y reclamos asociados con la inocuidad del producto y contar con registros que informen sobre las condiciones de manejo que se han dado al producto desde la producción primaria hasta el consumidor.
      .row(titulo="Norma NTC 512-1").p-0
        .col-md-12.mb-4.mb-md-0
      ...
      .row(titulo="Resolución 719 de 2015 ").p-0
        .col-md-12.mb-4.mb-md-0
          ...
          p Esta resolución, además, tiene efecto tanto para personas naturales como jurídicas, que se encuentren interesadas en tramitar y conseguir ante el INVIMA, la notificación, permiso o registro sanitario de alimentos, o adelantar el procedimiento para habilitación de fábricas de alimentos de mayor riesgo en salud pública de origen animal localizadas en el exterior y a las autoridades sanitarias para lo de su competencia.
